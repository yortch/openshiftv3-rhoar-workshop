...
### Steps
We will clone a sample project from Github.  If you don't have Git installed you can download a zip file.
...
![](./images/4-a.vscode-01-clean_package.png)  

![](./images/4-a.vscode-02-build_success.png)  
...
Step 2: Select Deployment Type ‘I will build and run locally’  
